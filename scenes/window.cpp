...
main_screen::main_screen(QWidget* parent) : QMainWindow(parent),mButtonPressedAmt(0)
{
  ...
  QObject::connect(this, &main_screen::sigLabelTextUpdated, this, [this](std::string_view val){
    std::cout << val << std::endl;
  });
}
void main_screen::updateLabelText()
{
